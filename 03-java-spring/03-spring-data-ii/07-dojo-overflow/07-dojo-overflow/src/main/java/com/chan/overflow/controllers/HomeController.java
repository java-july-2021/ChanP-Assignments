package com.chan.overflow.controllers;
...
import com.chan.overflow.services.OverflowService;
import com.chan.overflow.validators.TagValidator;
...
public class HomeController {
	...
	public String AddAnswer(@Valid @ModelAttribute("answer") Answer answer, BindingResult result, Model viewModel) {
		if(result.hasErrors()) {
			viewModel.addAttribute("question", this.oService.findOneQuestion(answer.getId()));
			return "show.jsp";
		}
